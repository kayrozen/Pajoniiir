 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "custom:JC1060P470C_I_W_Y"
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DSI_LANE_RATE_MBPS     (800)  // Single lane bit rate, should check the LCD drive IC
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_HPW                (24)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_HBP                (136)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_HFP                (160)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_VPW                (2)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_VBP                (21)
