# [espressif](https://components.espressif.com/components?q=namespace:espressif)/esp\_wifi\_remote
...
Utility wrapper for esp\_wifi functionality on remote targets

[Readme](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/readme?language=en) [Dependencies 3](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/dependencies?language=en) [Dependents 19](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/dependents?language=en) [Examples 2](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/examples?language=en) [Versions 88](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/versions?language=en)
...
Functionally, `esp_wifi_remote` wraps the public API of `esp_wifi`, offering a set of function call namespaces prefixed with esp\_wifi\_remote. These calls are translated into Remote Procedure Calls (RPC) to another target device (referred to as the "slave" device), which then executes the appropriate `esp_wifi` APIs.
...
| --- | --- | --- |
| esp\_hosted | ~50Mbps | High-performance applications |
| wifi\_remote\_over\_eppp | ~20Mbps | Encrypted communication |
| wifi\_remote\_over\_at | ~2Mbps | Standard AT protocol compatibility |
...
Please check the [README.md](https://github.com/espressif/esp-wifi-remote/tree/f213a752cbf435c836d6f31c6234f4162373918e/components/esp_wifi_remote/scripts/README.md) for more details on the generation step and testing consistency.

#### Links

- Homepage[Homepage](https://github.com/espressif/esp-wifi-remote)
- Repository[Repository](https://github.com/espressif/esp-wifi-remote/tree/f213a752cbf435c836d6f31c6234f4162373918e/components/esp_wifi_remote)


f213a752cbf435c836d6f31c6234f4162373918e

- License[License](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/license?language=en)
- Changelog[Changelog](https://components.espressif.com/components/espressif/esp_wifi_remote/versions/1.6.4/changelog?language=en)
...
idf.py add-dependency "espressif/esp\_wifi\_remote^1.6.4"


[download archive](https://components.espressif.com/api/downloads/?object_type=component&object_id=28d0f5bd-0ada-4c8f-b8c9-586f823e3fa8)
...
Archive size ~ 1.31 MB


- Downloaded in total


Downloaded in total 709.4k times


- Weekly DownloadsWeekly Downloads (All Versions)

19.0kSep 14, 2026 — Sep 20, 2026

- Downloaded this version


This version: 77.8k times



#### Badge

![espressif/esp_wifi_remote version: 1.6.4](https://components.espressif.com/components/espressif/esp_wifi_remote/badge.svg)
...
[report abuse](mailto:components@espressif.com?subject=Report%20Abuse%20-%20espressif/esp_wifi_remote%20v1.6.4)