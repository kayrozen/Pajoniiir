...
#define SERVICE_LOG_EVENTS(X)                          \
    ...
    X(SERVICE_LOG_AUDIO_WDT_TRACE,    "AUDIO_WDT_TRACE") \
    X(SERVICE_LOG_LIBRARY_LOAD_TRACE, "LIBRARY_LOAD_TRACE") \
    X(SERVICE_LOG_AUDIO_RING_STARVE,  "AUDIO_RING_STARVATION") \
    X(SERVICE_LOG_AUDIO_RATE_CHANGED, "AUDIO_SAMPLE_RATE_CHANGED") \
    X(SERVICE_LOG_UAC_DATA_LOSS,      "UAC_DATA_LOSS") \
    X(SERVICE_LOG_UAC_RING_PRESSURE,  "UAC_RING_PRESSURE") \
    X(SERVICE_LOG_RETIRED_30,         "RETIRED_EVENT_30")  \
    X(SERVICE_LOG_RETIRED_31,         "RETIRED_EVENT_31")  \
    X(SERVICE_LOG_RETIRED_32,         "RETIRED_EVENT_32")  \
    X(SERVICE_LOG_RETIRED_33,         "RETIRED_EVENT_33")  \
    ...
    X(SERVICE_LOG_RETIRED_43,         "RETIRED_EVENT_43")  \
    X(SERVICE_LOG_RETIRED_44,         "RETIRED_EVENT_44")  \
    X(SERVICE_LOG_RETIRED_45,         "RETIRED_EVENT_45")  \
